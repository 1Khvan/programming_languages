...
word = input('Введите слово либо только английскими, либо только русскими буквами: ')
    ...
    for letter in word:
        for key, value in list_English.items():
            if letter.upper() in value:
                summa += key
    print(f'ценность введенного английского слова = {summa}')
else:
    if word[0].lower() in rus:
        ...
        for letter in word:
            ...
            for key, value in list_Russian.items():
                if letter.upper() in value:
                    summa += key
    print(f'ценность введенного русского слова = {summa}')